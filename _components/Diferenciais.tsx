  ...
  return (
    <div className='flex  gap-8 justify-center items-center flex-wrap mb-20'>
      ...
      {diferenciais.map((d , index) => (
        <div className='flex justify-center text-center h-30 p-4 gap-2 w-30 items-center flex-col md:gap-4 bg-[#f5f5f5] rounded-md shadow-lg lg:w-70 lg:h-40' key={index}>
            ...
            <div className='flex justify-center items-center' >
             ...
             <div className='flex justify-center w-10 lg:w-60 text-center'>
